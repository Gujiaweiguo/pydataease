...
1. Queries CoreSysVariableUserValue for the current user's variable values
2. For each sysvar-type row permission rule, substitutes the variable name in filter_sql with the user's value
