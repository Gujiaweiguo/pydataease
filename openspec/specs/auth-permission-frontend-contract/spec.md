# auth-permission-frontend-contract Specification

## Purpose
TBD - created by archiving change complete-auth-permission-frontend-contract. Update Purpose after archive.
## Requirements
