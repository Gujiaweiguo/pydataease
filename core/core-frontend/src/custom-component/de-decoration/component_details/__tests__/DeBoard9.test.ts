...
import DeBoard9 from '../DeBoard9.vue'
...
describe('DeBoard9.vue', () => {
  it('renders the component', () => {
    const wrapper = shallowMount(DeBoard9, { props: createProps() })
    expect(wrapper.exists()).toBe(true)
  })

  it('renders the root container with correct class', () => {
    const wrapper = shallowMount(DeBoard9, { props: createProps() })
    expect(wrapper.find('.dv-border-box-9').exists()).toBe(true)
  })
  ...
  it('accepts duration prop', () => {
    const wrapper = shallowMount(DeBoard9, {
      props: createProps({ duration: 15 })
    })
    expect(wrapper.exists()).toBe(true)
  })
  ...
  it('accepts custom colors', () => {
    const wrapper = shallowMount(DeBoard9, {
      props: createProps({ color: ['#00ff00', '#0000ff'] })
    })
    expect(wrapper.exists()).toBe(true)
  })
})
