...
import DeBoard4 from '../DeBoard4.vue'
...
describe('DeBoard4.vue', () => {
  it('renders the component', () => {
    const wrapper = shallowMount(DeBoard4, { props: createProps() })
    expect(wrapper.exists()).toBe(true)
  })

  it('renders the root container with correct class', () => {
    const wrapper = shallowMount(DeBoard4, { props: createProps() })
    expect(wrapper.find('.dv-border-box-4').exists()).toBe(true)
  })
  ...
  it('applies style based on curStyle and scale', () => {
    const wrapper = shallowMount(DeBoard4, {
      props: createProps({ curStyle: { width: 800, height: 600 }, scale: 2 })
    })
    const style = wrapper.find('.dv-border-box-4').attributes('style')
  ...
  it('accepts custom colors', () => {
    const wrapper = shallowMount(DeBoard4, {
      props: createProps({ color: ['#111111', '#222222'] })
    })
    expect(wrapper.exists()).toBe(true)
  })
})
