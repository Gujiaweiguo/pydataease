...
vi.mock('@/store/modules/data-visualization/dvMain', () => ({
  dvMainStoreWithOut: () => ({
    curComponent: { frameLinks: { src: 'https://example.com' } },
    mobileInPc: false
  })
}))
...
const globalStubs = {
  ...
  FrameLinks: {
    template: '<div class="frame-links" />',
    props: ['frameLinks', 'themes']
  }
}

describe('de-frame/Attr.vue', () => {
  ...
  it('accepts themes prop override', () => {
