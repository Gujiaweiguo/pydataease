...
vi.mock('pinia', async importOriginal => {
  ...
  return {
    ...actual,
    storeToRefs: () => ({ curComponent: ref(mockCurComponent), mobileInPc: ref(false) })
  }
})
...
describe('picture/Attr', () => {
  ...
  it('passes themes prop to CommonAttr', () => {
