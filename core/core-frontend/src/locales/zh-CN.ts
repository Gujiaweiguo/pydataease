export default {
  common: {
    ...
    sqlbot_mode: '小助手模式',
    sqlbot_mode_basic: '基础小助手',
    sqlbot_mode_advanced: '高级小助手',
    sqlbot_api_key: 'API 密钥',
    sqlbot_api_key_placeholder: '请输入高级小助手的 API 密钥',
    sqlbot_aes_key: 'AES 密钥',
    sqlbot_aes_key_placeholder: '请输入高级小助手的 AES 密钥',
    sqlbot_aes_iv: 'AES IV',
    sqlbot_aes_iv_placeholder: '请输入高级小助手的 AES IV',
  ...
  system: {
    ...
    replace_image: '替换图片',
    about_settings: '关于设置',
    navigate_logo: '导航栏Logo',
    about_bg: '关于背景图',
    about_content: '产品描述',
    about_content_label: '产品描述',
    about_logo: '关于Logo',
    about_logo_fallback_tip: '如未配置，将使用导航栏Logo',
    about_edition: '版本',
    about_version: '版本号',
    about_corporation: '授权给',
    about_expired: '过期时间',
    about_count: '授权数量',
    about_serial_no: '序列号',
    about_remark: '备注',
  ...
  dataset: {
    ...
    parse_error: 'Excel解析失败，请检查格式、字段等信息。具体参考：#',
  ...
  visualization: {
    ...
    add_event: '添加事件',
    input_full_url: '请输入完整的 URL',
    input_alert_content: '请输入要 alert 的内容',
    component_move_out_tab: '组件将被移出Tab',
    jump_no_dashboard_tips: '未指定跳转仪表板',
    ...
    upload_det2_template: '上传 .DET2 文件',
  ...
  template_manage: {
    ...
    preview: '预览',
    workflow_tip_det2:
      '`.DET2` 用于可复用的本地模板。导出的 `.DET2` 文件可在此导入，导入后会进入本地模板库。',
    workflow_tip_det2app:
      '`.DET2APP` 用于应用型模板包；同样通过这里导入，并继续纳入本地模板库流程中复用。',
    open_import_entry: '前往模板导入',
    market_import_tip:
      '如果要导入自己的 `.DET2` / `.DET2APP` 文件，请前往模板管理中的标准导入入口。',
    market_reuse_tip: '导入后的模板会进入本地模板库，之后可回到这里并从“模板管理”来源中继续复用。',
    resource_upload_tip:
      '这里上传 `.DET2` 仅用于本次新建。若要把 `.DET2` / `.DET2APP` 纳入可复用的本地模板库，请使用“模板管理 > 导入模板”。'
  },
  work_branch: {
    new_empty: '空白新建',
    new_folder: '新建文件夹',
  ...
  auth_provider: {
    ...
    create: '新建提供商',
    edit: '编辑提供商',
    delete_confirm: '确认删除该认证提供商？删除后不可恢复。',
  ...
  embed_control: {
    ...
    allowed_domains_placeholder: '留空表示允许所有域名',
    password_required: '需要密码',
    ticket_required: '需要票据',
    max_expiry_hours: '最大有效期(小时)',
    max_expiry_unlimited: '不限',
    resource_dashboard: '仪表板',
    resource_chart: '图表',
    resource_datav: '大屏',
    resource_dataFiling: '数据填报'
  },
  data_filing: {
    title: '数据填报',
    my_filing: {
      title: '我的填报',
      available_forms: '可填表单',
      my_submissions: '提交记录',
      fill: '填写',
      submit: '提交',
      submit_success: '提交成功',
      ...
      view_history: '查看记录',
      select_filing: '请选择一个填报配置查看记录',
      submit_time: '提交时间',
      error: '错误信息',
      invalid_email: '邮箱格式不正确',
      invalid_phone: '手机号格式不正确',
      max_length: '{0}长度不能超过{1}个字符',
      min_value: '{0}不能小于{1}',
      max_value: '{0}不能大于{1}'
    },
    tab_configs: '填报配置',
    ...
    config_status: '状态',
    config_target: '目标',
    config_form_schema: '表单定义',
    config_field_mapping: '字段映射',
    config_idempotency: '幂等窗口(秒)',
    status_draft: '草稿',
    ...
    submission_pending: '待处理',
    submission_success: '成功',
    submission_failed: '失败',
    submission_retrying: '重试中',
    audit_action: '操作',
    audit_actor: '操作人',
    audit_outcome: '结果',
    audit_details: '详情',
    ...
    outcome_success: '成功',
    outcome_failure: '失败',
    publish_confirm: '确认发布该配置？发布后用户可以提交数据。',
    disable_confirm: '确认禁用该配置？禁用后用户无法提交数据。',
    publish_success: '填报配置发布成功',
    disable_success: '填报配置已禁用',
    retry_success: '重试已触发',
    form_builder: {
      title: '表单构建器',
      field_palette: '字段组件',
      ...
      basic: '基础',
      preview: '预览',
      empty_canvas_tip: '点击左侧组件添加表单项',
      option_label: '选项标签',
      option_value: '选项值',
      save: '保存',
      cancel: '取消',
      default_option: '选项',
      invalid_field_mapping: '字段映射 JSON 格式不正确',
      fields: {
        input: '单行文本',
        textarea: '多行文本',
        number: '数字',
