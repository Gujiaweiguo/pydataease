export default {
  common: {
    ...
    sqlbot_mode: 'Assistant Mode',
    sqlbot_mode_basic: 'Basic Assistant',
    sqlbot_mode_advanced: 'Advanced Assistant',
    sqlbot_api_key: 'API Key',
    sqlbot_api_key_placeholder: 'Enter the API Key for advanced assistant',
    sqlbot_aes_key: 'AES Key',
    sqlbot_aes_key_placeholder: 'Enter the AES Key for advanced assistant',
    sqlbot_aes_iv: 'AES IV',
    sqlbot_aes_iv_placeholder: 'Enter the AES IV for advanced assistant',
  ...
  system: {
    ...
    navigate_logo: 'Navigation Bar Logo',
    about_bg: 'About Background',
    about_content: 'Product Description',
    about_content_label: 'Product Description',
    about_logo: 'About Logo',
    about_logo_fallback_tip: 'If not configured, the navigation bar logo will be used',
    about_edition: 'Edition',
    about_version: 'Version',
    about_corporation: 'Licensed To',
    about_expired: 'Expiration',
    about_count: 'License Count',
    about_serial_no: 'Serial Number',
    about_remark: 'Remark',
  ...
  auth_provider: {
    ...
    edit: 'Edit Provider',
    delete_confirm: 'Are you sure you want to delete this auth provider? This cannot be undone.',
  ...
  embed_control: {
    title: 'Embed Control',
    resource_type: 'Resource Type',
    embed_enabled: 'Allow Embedding',
    allowed_domains: 'Allowed Domains',
    allowed_domains_placeholder: 'Leave empty to allow all domains',
    password_required: 'Password Required',
    ticket_required: 'Ticket Required',
    max_expiry_hours: 'Max Expiry (hours)',
    max_expiry_unlimited: 'Unlimited',
    resource_dashboard: 'Dashboard',
    resource_chart: 'Chart',
    resource_datav: 'DataV',
    resource_dataFiling: 'Data Filing'
  },
  data_filing: {
    title: 'Data Filing',
    my_filing: {
      ...
      no_forms: 'No filing forms available',
      no_submissions: 'No submissions yet',
      filling_config: 'Filing Config',
      form_closed: 'Close Form',
      current_filing: 'Current Filing',
      target_table: 'Target Table',
      submit_count: 'Submission Count',
      submit_count_unknown: '--',
      view_history: 'View History',
      select_filing: 'Select a filing config to view submissions',
      submit_time: 'Submit Time',
      error: 'Error',
      invalid_email: 'Invalid email format',
      invalid_phone: 'Invalid phone format',
      max_length: '{0} cannot exceed {1} characters',
      min_value: '{0} cannot be less than {1}',
      max_value: '{0} cannot be greater than {1}'
    },
    ...
    config_form_schema: 'Form Schema',
    config_field_mapping: 'Field Mapping',
    config_idempotency: 'Idempotency Window (s)',
    status_draft: 'Draft',
    ...
    publish_confirm: 'Publish this config? Users will be able to submit data.',
    disable_confirm: 'Disable this config? Users will not be able to submit data.',
    publish_success: 'Filing config published successfully',
    disable_success: 'Filing config disabled successfully',
    retry_success: 'Retry triggered successfully',
    form_builder: {
      title: 'Form Builder',
      ...
      basic: 'Basic',
      preview: 'Preview',
      empty_canvas_tip: 'Click a field from the left palette to add it',
      option_label: 'Option Label',
      option_value: 'Option Value',
      save: 'Save',
      cancel: 'Cancel',
      default_option: 'Option',
      invalid_field_mapping: 'Field mapping JSON is invalid',
      fields: {
  ...
  feature_flag: {
    ...
    watermark: 'Watermark',
    appearance: 'Appearance',
    embedding: 'Embed Control',
    platform_integration: 'Third-party Embed',
    data_filing: 'Data Filing',
    identification: 'Auth Settings',
    sys_variable_contract: 'System Variables',
    toggle_success: 'Feature flag updated successfully'
  },
  element_plus: {
    el: {
      pagination: {
