export default {
  common: {
    ...
    sqlbot_mode: '小助手模式',
    sqlbot_mode_basic: '基礎小助手',
    sqlbot_mode_advanced: '進階小助手',
    sqlbot_api_key: 'API 金鑰',
    sqlbot_api_key_placeholder: '請輸入進階小助手的 API 金鑰',
    sqlbot_aes_key: 'AES 金鑰',
    sqlbot_aes_key_placeholder: '請輸入進階小助手的 AES 金鑰',
    sqlbot_aes_iv: 'AES IV',
    sqlbot_aes_iv_placeholder: '請輸入進階小助手的 AES IV',
  ...
  system: {
    ...
    replace_image: '替換圖片',
    about_settings: '關於設置',
    navigate_logo: '導航欄Logo',
    about_bg: '關於背景圖',
    about_content: '產品描述',
    about_content_label: '產品描述',
    about_logo: '關於Logo',
    about_logo_fallback_tip: '如未配置，將使用導航欄Logo',
    about_edition: '版本',
    about_version: '版本號',
    about_corporation: '授權給',
    about_expired: '過期時間',
    about_count: '授權數量',
    about_serial_no: '序列號',
    about_remark: '備註',
  ...
  auth_provider: {
    ...
    create: '新建提供商',
    edit: '編輯提供商',
    delete_confirm: '確認刪除該認證提供商？刪除後不可恢復。',
  ...
  embed_control: {
    ...
    allowed_domains_placeholder: '留空表示允許所有域名',
    password_required: '需要密碼',
    ticket_required: '需要票據',
    max_expiry_hours: '最大有效期(小時)',
    max_expiry_unlimited: '不限',
    resource_dashboard: '儀表板',
    resource_chart: '圖表',
    resource_datav: '大屏',
    resource_dataFiling: '數據填報'
  },
  data_filing: {
    title: '數據填報',
    my_filing: {
      title: '我的填報',
      available_forms: '可填表單',
      my_submissions: '提交記錄',
      fill: '填寫',
      submit: '提交',
      submit_success: '提交成功',
      submit_failed: '提交失敗，請稍後重試',
      no_forms: '暫無可用填報',
      no_submissions: '暫無提交記錄',
      filling_config: '填報配置',
      form_closed: '關閉表單',
      current_filing: '當前填報',
      target_table: '目標表',
      ...
      view_history: '查看記錄',
      select_filing: '請選擇一個填報配置查看記錄',
      submit_time: '提交時間',
      error: '錯誤訊息',
      invalid_email: '郵箱格式不正確',
      invalid_phone: '手機號格式不正確',
      max_length: '{0}長度不能超過{1}個字元',
      min_value: '{0}不能小於{1}',
      max_value: '{0}不能大於{1}'
    },
    tab_configs: '填報配置',
    tab_submissions: '提交記錄',
    tab_audit: '審計日誌',
    config_name: '配置名稱',
    config_status: '狀態',
    config_target: '目標',
    config_form_schema: '表單定義',
    config_field_mapping: '欄位映射',
    config_idempotency: '冪等窗口(秒)',
    status_draft: '草稿',
    ...
    submission_pending: '待處理',
    submission_success: '成功',
    submission_failed: '失敗',
    submission_retrying: '重試中',
    audit_action: '操作',
    audit_actor: '操作人',
    audit_outcome: '結果',
    audit_details: '詳情',
    ...
    outcome_success: '成功',
    outcome_failure: '失敗',
    publish_confirm: '確認發佈該配置？發佈後使用者可以提交數據。',
    disable_confirm: '確認停用該配置？停用後使用者無法提交數據。',
    publish_success: '填報配置發佈成功',
    disable_success: '填報配置已停用',
    retry_success: '重試已觸發',
    form_builder: {
      title: '表單構建器',
      field_palette: '欄位元件',
      ...
      basic: '基礎',
      preview: '預覽',
      empty_canvas_tip: '點擊左側元件添加表單項',
      option_label: '選項標籤',
      option_value: '選項值',
      save: '保存',
      cancel: '取消',
      default_option: '選項',
      invalid_field_mapping: '欄位映射 JSON 格式不正確',
      fields: {
        input: '單行文本',
        textarea: '多行文本',
        number: '數字',
