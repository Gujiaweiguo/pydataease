...
const stubs = {
  ElSelectV2: {
    template: '<div />',
    props: ['modelValue', 'filterable', 'popperClass', 'showChecked', 'multiple', 'collapseTags', 'options', 'collapseTagsTooltip', 'placeholder', 'style']
  },
  ...
  ElSelect: { template: '<select><slot /></select>', props: ['modelValue', 'filterable', 'multiple'] },
  ...
  ElInputNumber: { template: '<input type="number" />', props: ['modelValue', 'min', 'max', 'size', 'controlsPosition'] },
